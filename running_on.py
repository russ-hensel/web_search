...
#       ...... as needed
   ...
   # ----------------------------------------------
    ...
    # ----------------------------------------------
    @classmethod
    def log_me_old (cls, logger, logger_level, print_flag  ):
        """
        for debugging -- rewrite out using get_str
        log and/or print info
        add log level, and defalut
        """
        cls.log_msg(  ">>>>>>>>>>> running_on() log_me() <<<<<<<<<<<<<",     logger, logger_level, print_flag )
        ...
        cls.log_msg(  "---------------- end running on --------------",  logger, logger_level, print_flag )


# ==============================================
if __name__ == '__main__':
    """
    do not run the app; this is here for convenience of launching just a bit of test
    """
